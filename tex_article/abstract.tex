...
Within this project we implement a program that uses the SIR model to simulate the outbreak of a pandemy. The 
program can olso operate backwards and estimate the SIR parameters of a given set of data by using the least 
squares method.

As variations on the theme we implement a forecasting program based on the logistic model, as well as a 
real-time graphic simulation of the spreading of a flu among a closed group of people.
